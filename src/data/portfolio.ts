...
export const portfolioData: PortfolioData = {
  ...
  caseStudies: [
    ...
    },
    {
      ...
      image: "/images/previews/activadigital.jpg",
      featured: true,
    },
    {
      slug: "factor",
      ...
      image: "/images/previews/factor-studio.jpg",
  ...
  experience: [
    ...
    },
    {
      ...
      logo: "/images/placeholder-mark.svg",
    },
    {
  ...
  projects: [
    ...
    },
    {
      ...
      image: "/images/previews/activadigital.jpg",
      gif: null,
      link: "https://www.activadigital.it/",
    ...
    },
    {
      title: "ArtCertify",
      description: {
        it: "Piattaforma dual-chain di Soulbound Token per la certificazione di beni culturali, nata per il progetto Roma Caput Mundi (PNRR / NextGenerationEU). Algorand-first (ARC-3 + ARC-19, Pera Wallet, JWT backend) con fork EVM su Base (ERC-721 + ERC-5192, Privy, Hardhat/Foundry). Storage ibrido MINIO + IPFS, certificati non-trasferibili.",
        en: "Dual-chain Soulbound Token platform for cultural-heritage certification, born from the Rome Caput Mundi project (PNRR / NextGenerationEU). Algorand-first (ARC-3 + ARC-19, Pera Wallet, JWT backend) with EVM fork on Base (ERC-721 + ERC-5192, Privy, Hardhat/Foundry). Hybrid MINIO + IPFS storage, non-transferable certificates.",
      },
      image: "/images/previews/artcertify.jpg",
      gif: null,
      link: "https://artcertify.com/",
    ...
    },
    {
      ...
      image: "/images/placeholder-mark.svg",
      gif: null,
